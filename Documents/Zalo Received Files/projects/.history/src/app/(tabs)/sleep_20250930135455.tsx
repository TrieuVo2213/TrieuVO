        ...
        {tab === 'journal' && (
          <YStack gap={16}>
            ...
            >
              ...
              {/* Mood */}
              <Text fontSize={13} color="#6B6B6B" style={{ marginTop: 8 }}>Tình trạng khi thức dậy</Text>
              <XStack alignItems="center" style={{ marginTop: 6 }}>
                {(['😴', '😐', '😊'] as Mood[]).map((m) => (
                  <Button
                    key={m}
              ...
              {/* Factors */}
              <Text fontSize={13} color="#6B6B6B" style={{ marginTop: 8 }}>Yếu tố ảnh hưởng</Text>
          ...
          <YStack gap={16}>
            ...
            <Card padding={16} borderRadius={12} borderWidth={1} borderColor="#E8ECF3" backgroundColor="#FFFFFF">
              ...
              {[
                ...
                <XStack key={story.title} alignItems="center" justifyContent="space-between" style={{ marginTop: 12 }}>
                  <YStack>
            ...
            <Card padding={16} borderRadius={12} borderWidth={1} borderColor="#E8ECF3" backgroundColor="#FFFFFF">
              ...
              <YStack style={{ marginTop: 12 }} gap={12}>
                <Card backgroundColor="#F3E8FF" borderRadius={12} padding={12}>
                  <Text fontSize={14} fontWeight="600" color={PRIMARY}>18/09/2025 · Phiêu lưu · Tích cực</Text>
                  <Text fontSize={13} style={{ marginTop: 4 }}>
                    Tôi mơ thấy mình bay lượn trên bầu trời, cảm giác tự do tuyệt vời.
                  </Text>
                  <Text fontSize={12} color="#6B6B6B" style={{ marginTop: 6 }}>
                    AI Insight: Thể hiện mong muốn tự chủ và khám phá.
                  </Text>
                </Card>
                <Card backgroundColor="#E6F9F0" borderRadius={12} padding={12}>
                  <Text fontSize={14} fontWeight="600" color="#2F9E55">19/09/2025 · Gia đình · Ấm áp</Text>
                  <Text fontSize={13} style={{ marginTop: 4 }}>
                    Ở nhà cùng gia đình, cảm giác bình yên và an toàn.
                  </Text>
                  <Text fontSize={12} color="#6B6B6B" style={{ marginTop: 6 }}>
                    AI Insight: Nhu cầu kết nối và được nâng đỡ về mặt cảm xúc.
                  </Text>
                </Card>
              </YStack>
            </Card>
