        ...
        {tab === 'journal' && (
          <YStack gap={16}>
            ...
            <Card
              ...
              style={{ marginTop: 12 }}
            >
              {/* Tiêu đề + nút seed demo */}
              <XStack alignItems="center" justifyContent="space-between">
                <XStack alignItems="center" gap={8}>
                  <Ionicons name="analytics-outline" size={20} color={PRIMARY} />
                  <Text fontSize={16} fontWeight="700">Thống kê giấc ngủ · 7 ngày gần nhất</Text>
                </XStack>
                <Button
                  height={36}
                  paddingHorizontal={12}
                  ...
                  onPress={seedDemo}
                >
                  <Text fontSize={13} color="#2A66D9" fontWeight="700">Thêm dữ liệu mẫu</Text>
                </Button>
              </XStack>
              ...
              <XStack
                ...
                borderRadius={8}
              >
                <Text style={{ width: 86 }} fontSize={12} color="#6B6B6B" fontWeight="700">Ngày</Text>
                <Text style={{ width: 84 }} fontSize={12} color="#6B6B6B" fontWeight="700">Đi ngủ</Text>
                <Text style={{ width: 84 }} fontSize={12} color="#6B6B6B" fontWeight="700">Thức dậy</Text>
                <Text style={{ width: 84 }} fontSize={12} color="#6B6B6B" fontWeight="700">Thời gian</Text>
                <Text style={{ width: 72 }} fontSize={12} color="#6B6B6B" fontWeight="700">Sao</Text>
                <Text style={{ flex: 1 }} fontSize={12} color="#6B6B6B" fontWeight="700">Mood</Text>
              </XStack>

              {/* Rows */}
              {weeklyEntries.length === 0 ? (
                <Text fontSize={13} color="#6B6B6B" style={{ marginTop: 10, paddingHorizontal: 2 }}>
                  Chưa có dữ liệu trong 7 ngày gần nhất. Hãy bấm “Lưu nhật ký ngủ” hoặc nút “Thêm dữ liệu mẫu”.
                </Text>
              ) : (
                weeklyEntries.map((e, idx) => {
                  const zebra = idx % 2 === 1;
                  return (
                    <XStack
                      key={e.dateISO}
                      ...
                      borderTopWidth={1}
                      borderColor="#F1F3F7"
                      backgroundColor={zebra ? '#FBFCFF' : '#FFFFFF'}
                      borderRadius={idx === weeklyEntries.length - 1 ? 8 : 0}
                    >
                      <Text style={{ width: 86 }} fontSize={13} fontWeight="700">{formatVN(e.dateISO)}</Text>
                      <Text style={{ width: 84 }} fontSize={13}>{e.bedTime}</Text>
                      <Text style={{ width: 84 }} fontSize={13}>{e.wakeTime}</Text>
                      <Text style={{ width: 84 }} fontSize={13}>{fmtDuration(e.durationMin)}</Text>

                      {/* Stars */}
                      <XStack style={{ width: 72 }} alignItems="center" gap={2}>
                        {Array.from({ length: 5 }).map((_, i) => (
                          <AntDesign
                            key={i}
                            name="star"
                      ...
                      >
                        <XStack
                          ...
                          borderWidth={1}
                          borderColor="#EEEFF6"
                          style={{ backgroundColor: '#FFF9E6' }} // vàng nhạt
                        >
