        ...
        {tab === 'journal' && (
          <YStack gap={16}>
            ...
            >
              ...
              {/* Header */}
              <XStack alignItems="center" paddingVertical={10} style={{ marginTop: 12 }}>
                <Text style={{ width: 86 }} fontSize={12} color="#6B6B6B">Ngày</Text>
                <Text style={{ width: 80 }} fontSize={12} color="#6B6B6B">Đi ngủ</Text>
                <Text style={{ width: 80 }} fontSize={12} color="#6B6B6B">Thức dậy</Text>
                <Text style={{ width: 80 }} fontSize={12} color="#6B6B6B">Thời gian</Text>
                <Text style={{ width: 60 }} fontSize={12} color="#6B6B6B">Sao</Text>
                <Text style={{ flex: 1 }} fontSize={12} color="#6B6B6B">Mood</Text>
              </XStack>

              {/* Rows */}
              {weeklyEntries.length === 0 ? (
                <Text fontSize={13} color="#6B6B6B" style={{ marginTop: 6 }}>
                  Chưa có dữ liệu trong 7 ngày gần nhất. Hãy bấm “Lưu nhật ký ngủ”.
                </Text>
              ) : (
                weeklyEntries.map((e) => (
                  <XStack
                    ...
                    borderColor="#F1F3F7"
                  >
                    <Text style={{ width: 86 }} fontSize={13}>{formatVN(e.dateISO)}</Text>
                    <Text style={{ width: 80 }} fontSize={13}>{e.bedTime}</Text>
                    <Text style={{ width: 80 }} fontSize={13}>{e.wakeTime}</Text>
                    <Text style={{ width: 80 }} fontSize={13}>{fmtDuration(e.durationMin)}</Text>
                    <XStack style={{ width: 60 }} alignItems="center" gap={2}>
                      {Array.from({ length: 5 }).map((_, i) => (
                        <AntDesign
                          key={i}
                          name="star"
                    ...
                    <Text style={{ flex: 1 }} fontSize={16}>{e.mood}</Text>
                  </XStack>
                ))
              )}
            </Card>
