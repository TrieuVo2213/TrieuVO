            ...
            <Card padding={16} borderRadius={12} borderWidth={1} borderColor="#E8ECF3" backgroundColor="#FFFFFF">
              ...
              <YStack style={{ marginTop: 12 }} gap={12}>
                {[
                {
                    ...
                    title: 'Phiêu lưu',
                    mood: 'Tích cực',
                    content: 'Tôi mơ thấy mình bay lượn trên bầu trời, cảm giác tự do tuyệt vời.',
                    insight: 'Thể hiện mong muốn tự chủ và khám phá.',
                    color: '#F3E8FF',
                ...
                },
                {
                    ...
                    title: 'Gia đình',
                    mood: 'Ấm áp',
                    content: 'Ở nhà cùng gia đình, cảm giác bình yên và an toàn.',
                    insight: 'Nhu cầu kết nối và được nâng đỡ về mặt cảm xúc.',
                    color: '#E6F9F0',
                    icon: 'home-outline',
                },
                ].map((dream, idx) => (
                ...
                >
                    <XStack alignItems="center" gap={8}>
                    <Ionicons name={dream.icon as any} size={18} color={PRIMARY} />
                    <Text fontSize={14} fontWeight="600" color={PRIMARY}>
                        {dream.date} · {dream.title} · {dream.mood}
                    </Text>
                    </XStack>

                    <Text fontSize={13} style={{ marginTop: 6 }}>
                    {dream.content}
                    </Text>

                    <Text fontSize={12} color="#6B6B6B" style={{ marginTop: 6 }}>
                    AI Insight: {dream.insight}
                    </Text>
                </Card>
                ))}
              </YStack>
